<template>
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10 shadow-lg">
    <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
      ...
      <tbody>
      <tr :class="++i%2 === 0 ? '' :'bg-gray-200'" v-for="attendance in allUserAttendance.attendances" :key="attendance" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
