<template>
  <h2 class="text-primary font-bold px-5 text-center mb-5 bg-green-200 w-1/2 mx-auto py-4 shadow-lg">All Attendance Of {{allUserDetails.attendances[0].userId.name}}</h2>
  <div class="flex justify-center item-center w-full">
    <div>
      <div class="flex flex-col">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div class="py-2 h-52 overflow-auto  align-middle inline-block min-w-full sm:px-6 lg:px-8">
